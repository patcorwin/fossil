...
#
# Created: Fri Apr 24 01:47:08 2020
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.rigStateTab.setTabText(self.rigStateTab.indexOf(self.tab_2), QtCompat.translate("MainWindow", "Spaces", None, -1))
        self.rigStateTab.setTabText(self.rigStateTab.indexOf(self.tab_8), QtCompat.translate("MainWindow", "Vis Groups", None, -1))
        self.rigStateTab.setTabText(self.rigStateTab.indexOf(self.tab_6), QtCompat.translate("MainWindow", "Shapes", None, -1))
        self.rigStateTab.setTabText(self.rigStateTab.indexOf(self.tab_7), QtCompat.translate("MainWindow", "Constraints", None, -1))
        self.rigStateTab.setTabText(self.rigStateTab.indexOf(self.tab_5), QtCompat.translate("MainWindow", "Connections", None, -1))
        self.rigStateTab.setTabText(self.rigStateTab.indexOf(self.tab_9), QtCompat.translate("MainWindow", "Set Driven", None, -1))
        self.rigStateTab.setTabText(self.rigStateTab.indexOf(self.tab_10), QtCompat.translate("MainWindow", "Custom Attrs", None, -1))
        self.rigStateTab.setTabText(self.rigStateTab.indexOf(self.tab_11), QtCompat.translate("MainWindow", "Locked Attrs", None, -1))
