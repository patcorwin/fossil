...
# Form implementation generated from reading ui file 'C:\guitar\Projects\_tools\_maya\fossil\pdil\tool\fossil/ui/rigToolUI.ui'
#
# Created: Thu Apr 23 00:18:25 2020
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_7 = QtWidgets.QPushButton(self.restoreContainer)
        self.pushButton_7.setObjectName("pushButton_7")
        self.layout.addWidget(self.pushButton_7, 0, 2, 1, 1)
        self.pushButton_8 = QtWidgets.QPushButton(self.restoreContainer)
        self.pushButton_8.setObjectName("pushButton_8")
        self.layout.addWidget(self.pushButton_8, 1, 2, 1, 1)
        self.pushButton_2 = QtWidgets.QPushButton(self.restoreContainer)
        self.pushButton_2.setObjectName("pushButton_2")
        self.layout.addWidget(self.pushButton_2, 0, 0, 1, 1)
        self.pushButton_3 = QtWidgets.QPushButton(self.restoreContainer)
        self.pushButton_3.setObjectName("pushButton_3")
        self.layout.addWidget(self.pushButton_3, 3, 0, 1, 1)
        self.pushButton = QtWidgets.QPushButton(self.restoreContainer)
        self.pushButton.setObjectName("pushButton")
        self.layout.addWidget(self.pushButton, 1, 0, 1, 1)
        self.pushButton_4 = QtWidgets.QPushButton(self.restoreContainer)
        self.pushButton_4.setObjectName("pushButton_4")
        self.layout.addWidget(self.pushButton_4, 0, 1, 1, 1)
        self.pushButton_5 = QtWidgets.QPushButton(self.restoreContainer)
        self.pushButton_5.setObjectName("pushButton_5")
        self.layout.addWidget(self.pushButton_5, 1, 1, 1, 1)
        self.pushButton_6 = QtWidgets.QPushButton(self.restoreContainer)
        self.pushButton_6.setObjectName("pushButton_6")
        self.layout.addWidget(self.pushButton_6, 3, 1, 1, 1)
        ...
        self.pushButton_9 = QtWidgets.QPushButton(self.rigStateContainer)
        self.pushButton_9.setObjectName("pushButton_9")
        self.verticalLayout_6.addWidget(self.pushButton_9)
        self.tabWidget_2 = QtWidgets.QTabWidget(self.rigStateContainer)
        ...
        self.connectionsField = QtWidgets.QPlainTextEdit(self.tab_5)
        ...
        self.setDrivenField = QtWidgets.QPlainTextEdit(self.tab_9)
        ...
        self.customAttrsField = QtWidgets.QPlainTextEdit(self.tab_10)
        ...
        self.lockedAttrsField = QtWidgets.QPlainTextEdit(self.tab_11)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 353, 104))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_7.setText(QtCompat.translate("MainWindow", "Const", None, -1))
        self.pushButton_8.setText(QtCompat.translate("MainWindow", "Locked", None, -1))
        self.pushButton_2.setText(QtCompat.translate("MainWindow", "Space", None, -1))
        self.pushButton_3.setText(QtCompat.translate("MainWindow", "Shape", None, -1))
        self.pushButton.setText(QtCompat.translate("MainWindow", "Vis", None, -1))
        self.pushButton_4.setText(QtCompat.translate("MainWindow", "Conn", None, -1))
        self.pushButton_5.setText(QtCompat.translate("MainWindow", "Driven", None, -1))
        self.pushButton_6.setText(QtCompat.translate("MainWindow", "Attrs", None, -1))
        ...
        self.pushButton_9.setText(QtCompat.translate("MainWindow", "PushButton", None, -1))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_2), QtCompat.translate("MainWindow", "Spaces", None, -1))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_8), QtCompat.translate("MainWindow", "Vis Groups", None, -1))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_6), QtCompat.translate("MainWindow", "Shapes", None, -1))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_7), QtCompat.translate("MainWindow", "Constraints", None, -1))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_5), QtCompat.translate("MainWindow", "Connections", None, -1))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_9), QtCompat.translate("MainWindow", "Set Driven", None, -1))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_10), QtCompat.translate("MainWindow", "Custom Attrs", None, -1))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_11), QtCompat.translate("MainWindow", "Locked Attrs", None, -1))
        ...
        self.label_10.setText(QtCompat.translate("MainWindow", "RotateX", None, -1))
